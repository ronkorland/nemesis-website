        ...
        return {
            ...
            link: function ($scope, element, attrs) {
                ...
                function closeOtherContextMenu() {
                    var openContextMenu = document.getElementsByClassName("dropdown contextMenu open");
                    if (openContextMenu && openContextMenu.length > 0) {
                        Array.prototype.slice.call(openContextMenu).forEach(function (anchor, index, arr) {
